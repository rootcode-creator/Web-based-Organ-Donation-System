<?php
include('inc/ordermedicinehead.php');
session_start();
					...
					<div class="card-body">
						...
						<table class="table table-bordered table-hover table-striped">
							...
							<tbody>
								...
								$sql = "SELECT * FROM prescription WHERE id = '" . $_POST['applicationid'] . "'";
								...
								<tr>
									...
									<td><?php echo $result['prescription_written_date']; ?></td>
		...
		<div class="container" style="display: flex;align-items: center;justify-content: center;">
			...
			<div class="row">
				...
				<form method="post" action="ordermedicine.php">
					...
					<div>
						<label for="Medicine 1">Medicine 1:&nbsp</label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med1name"   >

						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med1quantity"   >

					</div>

					<div>
						<label for="Medicine 2">Medicine 2:&nbsp</label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med2name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med2quantity"   >

					</div>


					<div>
						<label for="Medicine 3">Medicine 3:&nbsp</label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med3name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med3quantity"   >

					</div>

					<div>
						<label for="Medicine 4">Medicine 4:&nbsp</label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med4name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med4quantity"   >

					</div>

					<div>
						<label for="Medicine 5">Medicine 5:&nbsp</label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med5name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med5quantity"   >

					</div>

					<div>
						<label for="Medicine 6">Medicine 6:&nbsp</label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med6name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med6quantity"   >

					</div>


					<div>
						<label for="Medicine 7">Medicine 7:&nbsp</label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med7name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med7quantity"   >

					</div>

					<div>
						<label for="Medicine 8">Medicine 8:&nbsp</label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med8name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med8quantity"   >

					</div>


					<div>
						<label for="Medicine 9">Medicine 9:&nbsp</label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med9name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med9quantity"   >

					</div>

					<div>
						<label for="Medicine 10">Medicine 10: </label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med10name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med10quantity"   >

					</div>
					<div>
						<label for="Medicine 11">Medicine 11: </label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med11name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med11quantity"   >

					</div>

					<div>
						<label for="Medicine 12">Medicine 12: </label>
						<input type="text" class="input"  placeholder="Enter Med Name" name="med12name"   >
						&nbsp&nbsp&nbsp
						<input type="number" class="input"   placeholder="Enter Med Quantity" name="med12quantity"   >
					...
					<input type="hidden" name="patientname" value="<?php echo $_POST['patientname'] ?>">
					<input type="hidden" name="patientphone" value="<?php echo $_POST['patientphone'] ?>">
					<input type="hidden" name="patientgender" value="<?php echo $_POST['patientgender'] ?>">
					<input type="hidden" name="patientbloodgroup" value="<?php echo $_POST['patientbloodgroup'] ?>">
					<input type="hidden" name="doctor" value="<?php echo $_POST['doctor'] ?>">
					<input type="hidden" name="prescriptionwrittendate" value="<?php echo $_POST['prescriptionwrittendate'] ?>">
					<input type="hidden" name="prescription" value="<?php echo $_POST['prescription'] ?>">


					<div style="display: flex;align-items: center;justify-content: center;">
						<input type="submit" value="ORDER" name="order" class="btn btn-outline-primary btn-sm">
					</div>
				</form>
						...
						<tbody>
							...
							?>
								...
								<tr>
									...
									<form action="ordermedicine.php" method="POST">



										<td><input type="text" style="height:150px ;width: 280px" placeholder="Medicine quantity format (50,50,50)" name="quantity"> </td>
										...
										<td>
											...
											<input type="submit" value="ORDER" name="order" class="btn btn-outline-primary btn-sm" style="border: radius 5px;position: center;">
									</form>
